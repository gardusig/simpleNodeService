...
export async function asyncAssertInitialSeed(
...
export async function asyncAssertGetExistentElement(
  client: AbstractClient,
  idKey: string,
  inputData: any,
) {
...
export async function asyncAssertGetNonExistentElement(
  client: AbstractClient,
  idKey: string,
  inputData: any,
): Promise<void> {
  const id = getIdFromInputData(idKey, inputData);
  await expect(
    client.get!(HEADER_WITH_VALID_CREDENTIALS, id),
  ).rejects.toHaveProperty("response.status", HttpStatus.NOT_FOUND);
}

export async function asyncAssertUpdateExistentElement(
  client: AbstractClient,
  idKey: string,
  inputData: any,
): Promise<void> {
...
export async function asyncAssertUpdateNonExistentElement(
  client: AbstractClient,
  idKey: string,
  inputData: any,
): Promise<void> {
  const id = getIdFromInputData(idKey, inputData);
  await expect(
    client.update!(HEADER_WITH_VALID_CREDENTIALS, id, inputData),
  ).rejects.toHaveProperty("response.status", HttpStatus.NOT_FOUND);
}

export async function asyncAssertDeleteExistentElement(
  client: AbstractClient,
  idKey: string,
  inputData: any,
): Promise<void> {
...
export async function asyncAssertDeleteNonExistentElement(
  client: AbstractClient,
  idKey: string,
  inputData: any,
): Promise<void> {
  const id = getIdFromInputData(idKey, inputData);
  await expect(
    client.delete!(HEADER_WITH_VALID_CREDENTIALS, id),
  ).rejects.toHaveProperty("response.status", HttpStatus.NOT_FOUND);
}

export async function asyncAssertAddExistentElement(
  client: AbstractClient,
  inputData: any,
) {
  await expect(
    client.create!(HEADER_WITH_VALID_CREDENTIALS, inputData),
  ).rejects.toHaveProperty("response.status", HttpStatus.CONFLICT);
}

export async function asyncAssertAddNonExistentElement(
  client: AbstractClient,
  idKey: string,
  inputData: any,
) {
...
export async function asyncAssertDeleteAllExistingElements(
  client: AbstractClient,
  idKey: string,
) {
  const response = await client.getAll!(HEADER_WITH_VALID_CREDENTIALS)!;
...
export async function asyncAssertGetAllIsEmpty(
  client: AbstractClient,
): Promise<void> {
  const response = await client.getAll!(HEADER_WITH_VALID_CREDENTIALS)!;
  expect(response).toBeDefined();
...
function assertExpectedResponseBody(
