...
function createInitialSeedTest(client: AbstractClient): TestDefinition {
  return {
    ...
    testFunction: () => asyncAssertInitialSeed(client),
  };
}

function createGetNonExistentElementTest(
  ...
  return {
    ...
    testFunction: () =>
      asyncAssertGetNonExistentElement(client, mockData.idKey, mockData.data),
  };
}

function createUpdateNonExistentElementTest(
  client: AbstractClient,
  mockData: MockData,
): TestDefinition {
  return {
...
function createUpdateExistentElementTest(
  client: AbstractClient,
  mockData: MockData,
): TestDefinition {
  return {
...
function createDeleteNonExistentElementTest(
  client: AbstractClient,
  mockData: MockData,
): TestDefinition {
  return {
...
function createDeleteAllExistingElementsTest(
  client: AbstractClient,
  mockData: MockData,
): TestDefinition {
  return {
    ...
    testFunction: () =>
      asyncAssertDeleteAllExistingElements(client, mockData.idKey),
  };
}

function createAddNonExistentElementTest(
  client: AbstractClient,
  mockData: MockData,
): TestDefinition {
  return {
    ...
    testFunction: () =>
      asyncAssertAddNonExistentElement(client, mockData.idKey, mockData.data),
  };
}

function createAddExistentElementTest(
  client: AbstractClient,
  mockData: MockData,
): TestDefinition {
  return {
    ...
    testFunction: () => asyncAssertAddExistentElement(client, mockData.data),
  };
}
